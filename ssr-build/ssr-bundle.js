    ...
    var processedRuns = runs.map(function (a) {
      ...
      var res = _objectSpread({
        ...
        players: players.map(function (p) {
          var _p$name;
          return {
            url: p.rel === 'user' && "https://www.speedrun.com/user/".concat(players[p.id]),
...
/* harmony import */ var _tanstack_react_table__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("pcq1");
/* harmony import */ var _tanstack_react_table__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("Y4LV");
/* harmony import */ var _processData__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("2+fx");
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
...
var columnHelper = Object(_tanstack_react_table__WEBPACK_IMPORTED_MODULE_5__[/* createColumnHelper */ "a"])();
...
var Home = function Home() {
  ...
  Object(preact_hooks__WEBPACK_IMPORTED_MODULE_1__[/* useEffect */ "d"])(function () {
    Object(_processData__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])().then(function (_ref2) {
      var processedRuns = _ref2.processedRuns;
      setProcessedRuns(processedRuns);
    });
  }, []);
  var table = Object(_tanstack_react_table__WEBPACK_IMPORTED_MODULE_6__[/* useReactTable */ "b"])({
    data: processedRuns,
    columns: columnDefs,
    getCoreRowModel: Object(_tanstack_react_table__WEBPACK_IMPORTED_MODULE_5__[/* getCoreRowModel */ "c"])(),
    getSortedRowModel: Object(_tanstack_react_table__WEBPACK_IMPORTED_MODULE_5__[/* getSortedRowModel */ "e"])(),
    getFilteredRowModel: Object(_tanstack_react_table__WEBPACK_IMPORTED_MODULE_5__[/* getFilteredRowModel */ "d"])()
  });
  return Object(preact__WEBPACK_IMPORTED_MODULE_2__["h"])("div", {
    ...
    return Object(preact__WEBPACK_IMPORTED_MODULE_2__["h"])("tr", {
      ...
      }, Object(_tanstack_react_table__WEBPACK_IMPORTED_MODULE_6__[/* flexRender */ "a"])(header.column.columnDef.header, header.getContext()), (_asc$desc = {
        asc: ' 🔼',
        desc: ' 🔽'
    ...
    return Object(preact__WEBPACK_IMPORTED_MODULE_2__["h"])("tr", {
      ...
      return Object(preact__WEBPACK_IMPORTED_MODULE_2__["h"])("td", {
        key: cell.id
      }, Object(_tanstack_react_table__WEBPACK_IMPORTED_MODULE_6__[/* flexRender */ "a"])(cell.column.columnDef.cell, cell.getContext()));
    }));
  }))));
};
